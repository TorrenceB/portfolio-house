  ...
  data: () => ({
    projects: [
      ...
      },
      {
        ...
        text: "In addition to creating a mobile prototype for a Civil Engagement Start Up, I was tasked with developing a landing page to demonstrate our product. The main hurdles that I was able to overcome included form validation on the Front End, setting up user authentication with Firebase and handling user objects to send customized emails. Stack: React.js, Firebase",
      },
      {
        id: Math.floor(Math.random() * 1000),
        title: "Swandoola Practitioner Application",
        text: "I define this project as the first true application of my development skills to a real world project. My key responsibility was to design an interface for an application of which holistic Health Practitioners were able to maintain accountable relationships with their clients and manage client records. Stack: Flutter ",
      },
    ],
  }),
};
